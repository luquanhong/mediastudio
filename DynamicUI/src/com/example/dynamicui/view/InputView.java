package com.example.dynamicui.view;
...
import com.example.dynamicui.input.InputValue;
...
public class InputView extends ImageView {
	...
	public void setMAME4droid(MainActivity mm) {
		this.mm = mm;
...
//		}		
	...
	protected void onDraw(Canvas canvas) {
        ...
        for(int i=0; i<data.size();i++)
        {
        	...
        	else if(v.getType()==InputHandler.TYPE_ANALOG_RECT && canvas.getClipBounds().intersect(v.getRect()) )
        	{
         	   if(!(mm.getMainHelper().getscrOrientation() == Configuration.ORIENTATION_LANDSCAPE ))
